export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію Nitro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} Nitro Code завантажено. Бажаєте встановити її та перезапустити?",
