export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de Nitro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de Nitro Code a été téléchargée. Voulez-vous l'installer et redémarrer ?",
