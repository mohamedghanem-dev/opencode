export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Nitro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Nitro Code er blevet downloadet. Vil du installere den og genstarte?",
