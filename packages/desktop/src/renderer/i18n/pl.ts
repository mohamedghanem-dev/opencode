export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Nitro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Nitro Code. Czy chcesz ją zainstalować i uruchomić ponownie?",
