export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Nitro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Nitro Code er lastet ned. Vil du installere den og starte på nytt?",
