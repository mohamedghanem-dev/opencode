export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Nitro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Nitro Code foi baixada. Você gostaria de instalá-la e reiniciar?",
