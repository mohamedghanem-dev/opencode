export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Nitro Code-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Nitro Code-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
