export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Nitro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Nitro Code wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
