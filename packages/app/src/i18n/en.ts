export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Nitro Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Nitro Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Nitro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Nitro Code.",
  ...
  "dialog.server.description": "Switch which Nitro Code server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Nitro Code",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Nitro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Nitro Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Nitro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Nitro Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Nitro Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Nitro Code",
  "wsl.onboarding.opencodeReadyIn": "Nitro Code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Nitro Code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Nitro Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Nitro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Nitro Code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Nitro Code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Nitro Code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Nitro Code.",
  ...
  "toast.update.description": "A new version of Nitro Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Nitro Code team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Nitro Code does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Nitro Code includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Nitro Code Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Nitro Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Nitro Code",
  ...
  "settings.general.row.appearance.description": "Customise how Nitro Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Nitro Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Nitro Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Nitro Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Nitro Code.",
