export const dict = {
  ...
  "dialog.server.description": "이 앱이 연결할 Nitro Code 서버를 전환합니다.",
  ...
  "error.page.report.prefix": "이 오류를 Nitro Code 팀에 제보해 주세요: ",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Nitro Code 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Nitro Code 표시 언어 변경",
  ...
  "settings.general.row.theme.description": "Nitro Code 테마 사용자 지정",
